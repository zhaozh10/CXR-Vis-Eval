...
# NIH constants
# #############################################
NIH_DATA_DIR = DATA_BASE_DIR / "NIH_X-ray"
NIH_TRAIN_CSV = NIH_DATA_DIR / "train.csv"
NIH_VALID_CSV = NIH_DATA_DIR / "val.csv"
NIH_TEST_CSV = NIH_DATA_DIR / "test.csv"
...
PNEUMOTHORAX_STAT=PNEUMOTHORAX_DATA_DIR / "dataset_statistics.json"
PNEUMOTHORAX_ORIGINAL_TRAIN_CSV = PNEUMOTHORAX_DATA_DIR / "train-rle.csv"
PNEUMOTHORAX_TRAIN_CSV = PNEUMOTHORAX_DATA_DIR / "train.csv"
PNEUMOTHORAX_VALID_CSV = PNEUMOTHORAX_DATA_DIR / "valid.csv"
PNEUMOTHORAX_TEST_CSV = PNEUMOTHORAX_DATA_DIR / "test.csv"
PNEUMOTHORAX_IMG_DIR = PNEUMOTHORAX_DATA_DIR / "processed_images"
PNEUMOTHORAX_MASK_DIR = PNEUMOTHORAX_DATA_DIR / "masks"
PNEUMOTHORAX_IMG_SIZE = 512
PNEUMOTHORAX_TRAIN_PCT = 0.6
...
CHESTSTRUCT_DATA_DIR = DATA_BASE_DIR / "ChestStruct"
CHESTSTRUCT_IMG_DIR = DATA_BASE_DIR / "ChestStruct"
CHESTSTRUCT_TRAIN_JSON = CHESTSTRUCT_DATA_DIR / "train.json"
CHESTSTRUCT_VALID_JSON = CHESTSTRUCT_DATA_DIR / "val.json"
CHESTSTRUCT_TEST_JSON = CHESTSTRUCT_DATA_DIR / "test.json"
