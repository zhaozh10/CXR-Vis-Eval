...
from downstream.datasets.classification_dataset import CheXpertImageDataset, RSNAImageDataset, COVIDXImageDataset
...
from downstream.models.convirt.convirt_module import ConVIRT
