...
from downstream.datasets.segmentation_dataset import (RSNASegmentDataset,
                                                SIIMSegDataset)
from downstream.models.backbones.transformer_seg import SETRModel
# from mgca.models.mgca.mgca_module import MGCA
from downstream.models.ssl_segmenter import SSLSegmenter
...
def cli_main():
    ...
    if args.dataset == "siim":
        datamodule = DataModule(dataset=SIIMSegDataset, collate_fn=None,
                                transforms=None, data_pct=args.data_pct,
                                batch_size=args.batch_size, num_workers=args.num_workers)
    elif args.dataset == "rsna":
        datamodule = DataModule(dataset=RSNASegmentDataset, collate_fn=None,
                                transforms=None, data_pct=args.data_pct,
                                batch_size=args.batch_size, num_workers=args.num_workers)
    # if args.ckpt_path:
    ...
    wandb_logger = WandbLogger(
        ...
        name=f"ImageNet_{args.dataset}_pct{args.data_pct}_{extension}_seed{args.seed}_lr{args.learning_rate}")
